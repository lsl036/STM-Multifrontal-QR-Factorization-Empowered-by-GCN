...
)
{
    ...
    * 如果A是对称的，则下三角形部分中的项可能存在，但这些被忽略。*/
    ...
    CORE(change_factor) (SPARSE_PATTERN, TRUE, TRUE, TRUE, TRUE, L, Common);
...
{
    return (CHOL(super_symbolic2) (SPARSE_ANALYZE_FOR_CHOLESKY,
        A, F, Parent, L, Common)) ;
}
