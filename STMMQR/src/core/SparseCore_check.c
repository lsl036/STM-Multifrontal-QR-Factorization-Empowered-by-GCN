...
)
{
    ...
    P3 ("  maxrank:    update/downdate rank:   "ID"\n",
	    (Int) SparseCore_maxrank (0, Common)) ;
...
)
{
	...
	if (Wi == NULL)
	{
	    SparseCore_allocate_work (0, nrow, 0, Common) ;
...
)
{
	...
	if (Wi == NULL)
	{
	    ...
	    SparseCore_allocate_work (0, n, 0, Common) ;
