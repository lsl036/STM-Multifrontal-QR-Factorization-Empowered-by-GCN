 ...
 * provided, one for int integers and the other for Sparse_long integers.
 *
...
Sparse_long amd_order    /* see above for description of arguments */
(
    Sparse_long n,
 ...
 *       Ap: an int/Sparse_long array of size n+1, containing column
 *              pointers of A.
 *       Ai: an int/Sparse_long array of size nz, containing the row
 ...
 *
 *       P: an int/Sparse_long array of size n, containing the output
...
/* contents of Info */
#define AMD_STATUS 0           /* return value of amd_order and amd_order */
