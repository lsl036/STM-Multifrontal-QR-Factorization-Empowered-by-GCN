...
sparse_factor *SparseChol_analyze (sparse_csc *, sparse_common *,char *) ;
...
sparse_factor *SparseChol_analyze_p2 (int, sparse_csc *, Sparse_long *,
    Sparse_long *, size_t, sparse_common *, char *) ;

int SparseChol_factorize (sparse_csc *, sparse_factor *, sparse_common *) ;

int SparseChol_factorize_p (sparse_csc *, double *, Sparse_long *,
