...
#define SPARSE_METIS 3
#define SPARSE_NESDIS 4
...
#define CHOLESKY_OMP_NUM_THREADS 4
...
void *SparseCore_malloc_onnode(size_t, size_t, size_t const, sparse_common *) ;

void *SparseCore_calloc (size_t, size_t, sparse_common *) ;

void *SparseCore_free (size_t, size_t, void *, sparse_common *) ;

void *SparseCore_numa_free (size_t, size_t, void *, sparse_common *) ;

void *SparseCore_realloc (size_t, size_t, void *, size_t *, sparse_common *) ;

void *SparseCore_numa_realloc (size_t, size_t, void *, size_t *, sparse_common *) ;
...
void *SparseCore_read_matrix (FILE *, int, int *, sparse_common *, FILE *, FILE *, int) ;
...
// 设置 符号分解中 合并超节点的松弛因子 参数 
#define RELAX_FOR_CHOL 0
#define RELAX_FOR_QR 1
